...
# EMAIL CONFIGURATION
# ============================================================================
# You can set these as environment variables or hardcode them (not recommended for production)

EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')  # Gmail SMTP server
EMAIL_PORT = int(os.getenv('EMAIL_PORT', 587))  # TLS port
EMAIL_USERNAME = os.getenv('EMAIL_USERNAME', 'your-email@gmail.com')  # Your email
EMAIL_PASSWORD = os.getenv('EMAIL_PASSWORD', 'your-app-password')  # App password (not regular password)
